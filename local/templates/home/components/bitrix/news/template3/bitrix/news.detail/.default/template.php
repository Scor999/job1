    ...
    <div class="container">
        <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
                ...
                <p class="mb-5"><strong class="h2 text-success font-weight-bold">&#8381;<?=number_format($arResult['DISPLAY_PROPERTIES']["ATT_PRICE"]["VALUE"], 2, ',', ' ')?></strong></p>
            </div>
        </div>
    </div>
</div>
        ...
        <div class="row">
            <div class="col-lg-8" style="margin-top: -150px;">
                <div class="mb-5">
                    <div class="slide-one-item home-slider owl-carousel">
                        <?if ($arResult['DISPLAY_PROPERTIES']['ATT_GALLERY'] && !$arResult['DISPLAY_PROPERTIES']['ATT_GALLERY']['ID']):?>
                            ...
                            <?endforeach;?>
                        <?elseif($arResult['DISPLAY_PROPERTIES']['ATT_GALLERY']):?>
                            <div><img src="<?=$arResult['DISPLAY_PROPERTIES']['ATT_GALLERY']['FILE_VALUE']['SRC']?>" alt="Image" class="img-fluid"></div>
                        <?else:?>
                ...
                <div class="bg-white">
                    <div class="row mb-5">
                        <div class="col-md-6">
                            <strong class="text-success h1 mb-3">&#8381;<?=number_format($arResult['DISPLAY_PROPERTIES']["ATT_PRICE"]["VALUE"], 2, ',', ' ')?></strong>
                        </div>
						<div class="col-md-6">
                            <ul class="property-specs-wrap mb-3 mb-lg-0  float-lg-right">
                                ...
                                <li>
                                    ...
                                    <span class="property-specs-number"><?=$arResult['DISPLAY_PROPERTIES']['ATT_GARAGE']['VALUE'] ?: 'нет'?></span>
                                </li>
                            </ul>
                        </div>
                    </div>
                    <div class="row mb-5">
                        ...
                        <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                            ...
                            <strong class="d-block"><?=$arResult['DISPLAY_PROPERTIES']['ATT_FLOORS']['VALUE']?></strong>
                        </div>
                        <div class="col-md-6 col-lg-4 text-left border-bottom border-top py-3">
                            <span class="d-inline-block text-black mb-0 caption-text">Общая площадь</span>
                            <strong class="d-block"><?=$arResult['DISPLAY_PROPERTIES']['ATT_SQUARE']['VALUE']?></strong>
                        </div>
                    </div>
                    ...
                    <div class="row mt-5">
                        <div class="col-12">
                            ...
                            <?elseif($arResult['DISPLAY_PROPERTIES']['ATT_GALLERY']):?>
                                <div class="col-sm-6 col-md-4 col-lg-3 mb-4">
                                    <a href="<?=$arResult['DISPLAY_PROPERTIES']['ATT_GALLERY']['FILE_VALUE']['SRC']?>" class="image-popup gal-item"><img src="<?=$arResult['DISPLAY_PROPERTIES']['ATT_GALLERY']['FILE_VALUE']['SRC']?>" alt="Image" class="img-fluid"></a>
                                </div>
                            <?else:?>
                    ...
                    <div class="row mt-5">
                        ...
                        <?if ($arResult['DISPLAY_PROPERTIES']['ATT_ADDITIONAL'] && !$arResult['DISPLAY_PROPERTIES']['ATT_ADDITIONAL']['ID']):?>
                            <? foreach ($arResult['DISPLAY_PROPERTIES']['ATT_ADDITIONAL']['FILE_VALUE'] as $material):?>
                                <div class="col-12">
                                    <a href="<?=$material['SRC']?>" class="image-popup gal-item"><?=$material['ORIGINAL_NAME']?></a>
                                </div>
                            <?endforeach;?>
                        <? elseif($arResult['DISPLAY_PROPERTIES']['ATT_ADDITIONAL']): ?>
                            <div class="col-12">
                                <a href="<?=$arResult['DISPLAY_PROPERTIES']['ATT_ADDITIONAL']['FILE_VALUE']['SRC']?>" class="image-popup gal-item"><?=$arResult['DISPLAY_PROPERTIES']['ATT_ADDITIONAL']['FILE_VALUE']['ORIGINAL_NAME']?></a>
                            </div>
                        <?else:?>
                    ...
                    <div class="row mt-5">
                        ...
                        <?if ($arResult['DISPLAY_PROPERTIES']['ATT_SOURCE']):?>
                            <? foreach ($arResult['DISPLAY_PROPERTIES']['ATT_SOURCE']['VALUE'] as $link):?>
                                <div class="col-12">
